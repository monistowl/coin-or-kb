 ...
 * Used as building block for CoinWarmStartDual and CoinWarmStartPrimalDual.
 *
 * @see CoinWarmStart for the abstract base class
 * @see CoinWarmStartDual which uses this for dual vector storage
 */
