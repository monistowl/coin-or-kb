...
/**
 * @file CoinSimpFactorization.hpp
 ...
 *
 * @algorithm Sparse LU with Markowitz Pivoting:
 ...
 *
 * @math LU factorization: PA = LU, L unit lower triangular, U upper triangular
 ...
 *
 * @complexity Factorization: O(n³) worst, typically O(n·nnz) with good pivoting
 ...
 * @see CoinFactorization for the optimized sparse implementation
 */
