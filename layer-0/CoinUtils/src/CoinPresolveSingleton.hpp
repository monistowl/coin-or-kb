...
/**
 * @file CoinPresolveSingleton.hpp
 * @brief Singleton row/column presolve transforms
 *
 * @algorithm Singleton Column/Row Elimination:
 ...
 *
 * @math For singleton row ax_j = b: x_j = b/a (fixed value)
 *   For singleton column in ax_j ≤ b with a > 0: x_j ≤ b/a
 *   For singleton column in ax_j ≥ b with a > 0: x_j ≥ b/a
 *
 * @complexity Time: O(1) per singleton processed
