 ...
 *
 * @algorithm LP Presolve - simplifies LP before solving via reversible transforms
 * @math Presolve applies a sequence of transformations T_k to original LP:
 ...
 *
 * @ref Andersen, E., Andersen, K. (1995). "Presolving in Linear Programming".
 *      Mathematical Programming 71:221-245.
 *
 * @see CoinPresolveDoubleton, CoinPresolveForcing, etc. for specific transforms
 */
