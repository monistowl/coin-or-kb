 ...
 *
 * @algorithm Indexed sparse vector - hybrid sparse/dense storage
 * @math Storage for n-dimensional vector with k nonzeros:
 ...
 *
 * @complexity Element access: O(1) via dense array
 ...
 *
 * @see CoinPackedVector for pure sparse storage
 * @see CoinDenseVector for pure dense storage
 */
