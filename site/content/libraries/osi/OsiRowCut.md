...
- [CoinPackedVector](@/libraries/coinutils/CoinPackedVector.md) for sparse row representation

## Source

Header file: {{ link(path="/browser/?library=Osi&file=src/Osi/OsiRowCut.hpp", text="`src/Osi/OsiRowCut.hpp`") }}
