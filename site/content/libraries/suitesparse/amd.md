+++
title = "amd"
description = "Approximate Minimum Degree ordering for sparse matrix factorization"
template = "page.html"

[extra]
layer = 0
library = "SuiteSparse"
header_file = "AMD/Include/amd.h"
+++
...
Header file: {{ link(path="/browser/?library=SuiteSparse&file=AMD/Include/amd.h", text="`AMD/Include/amd.h`") }}
