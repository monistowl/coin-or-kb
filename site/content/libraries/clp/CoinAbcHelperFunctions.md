...
- [AbcSimplex](/coin-or-kb/libraries/clp/abcsimplex/) which uses these for FTRAN/BTRAN

## Source

Header file: [`src/CoinAbcHelperFunctions.hpp`](/coin-or-kb/browser/?library=Clp&file=src/CoinAbcHelperFunctions.hpp)
