...
- [QProblem](@/libraries/qpoases/QProblem.md) for QPs with general linear constraints

## Source

Header file: {{ link(path="/browser/?library=qpOASES&file=include/qpOASES/QProblemB.hpp", text="`include/qpOASES/QProblemB.hpp`") }}
