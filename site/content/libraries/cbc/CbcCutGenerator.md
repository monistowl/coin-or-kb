+++
title = "CbcCutGenerator"
description = "Interface between Cbc and Cut Generation Library (CGL)"
template = "page.html"

[extra]
layer = 2
library = "Cbc"
header_file = "src/CbcCutGenerator.hpp"
+++
...
- [CbcModel](@/libraries/cbc/CbcModel.md)::addCutGenerator()

## Source

Header file: {{ link(path="/browser/?library=Cbc&file=src/CbcCutGenerator.hpp", text="`src/CbcCutGenerator.hpp`") }}
