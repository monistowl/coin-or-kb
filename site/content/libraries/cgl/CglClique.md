+++
title = "CglClique"
description = "Clique cuts from set packing structure"
template = "page.html"

[extra]
layer = 2
library = "Cgl"
header_file = "src/CglClique/CglClique.hpp"
+++
...
Greedy Maximal Clique (greedy_maximal_clique):
...
- CglOddHole for odd-hole cuts (related conflict graph structure)
- CglProbing for variable fixing from cliques
