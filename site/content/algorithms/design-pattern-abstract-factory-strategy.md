+++
title = "Design Pattern: Abstract Factory + Strategy"
...
All query methods (getColSolution, etc.): O(1) pointer return
...
- Lougee-Heimer et al. (2003). "The Common Optimization INterface
