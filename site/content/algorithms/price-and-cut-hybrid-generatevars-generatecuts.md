+++
title = "Price-and-Cut Hybrid (generateVars + generateCuts)"
...
Column generation: O(#iterations × pricing_cost)
...
- Dantzig, G.B. and Wolfe, P. (1960). "Decomposition principle for
       linear programs". Operations Research 8(1):101-111.
- Barnhart, C. et al. (1998). "Branch-and-price: Column generation
       for solving huge integer programs". Operations Research 46(3).
- Held, M. and Karp, R.M. (1971). "The traveling-salesman problem
