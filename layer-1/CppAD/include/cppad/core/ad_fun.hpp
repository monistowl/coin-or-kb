 ...
 *
 * @algorithm Forward mode computes derivatives in the direction of inputs.
 ...
 *
 * @see AD<Base> for the scalar type that records operations
 */
...
/**
 * @brief Function object storing recorded AD operations
 * @tparam Base Underlying numeric type (typically double)
 * @tparam RecBase Type used during recording (usually same as Base)
 *
 ...
 *
 * @invariant Once constructed, the function signature (n inputs, m outputs) is fixed
 */
