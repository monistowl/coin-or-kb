 ...
 * - Integrates with GUB structure for efficient handling
 *
 * @see ClpGubMatrix for the underlying GUB structure
 * @see ClpPackedMatrix which this extends
 * @see ClpSimplexPrimal which drives the column generation
 */
