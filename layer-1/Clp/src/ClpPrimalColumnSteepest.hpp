...
/**
 * @file ClpPrimalColumnSteepest.hpp
 * @brief Steepest edge and Devex pivot selection for primal simplex
 *
 * @algorithm Steepest Edge and Devex Primal Pivot Selection:
 ...
 *
 * @math Column weight: γ_j = ||B^{-1}a_j||² = d_j^T d_j where d_j is FTRAN of a_j.
 ...
 * @ref Harris, "Pivot selection methods of the Devex LP code",
 ...
 * @see ClpPrimalColumnDantzig for simpler Dantzig rule
