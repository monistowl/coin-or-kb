 ...
 * @ref Koberstein, "Progress in the dual simplex algorithm",
 ...
 * @see ClpSimplexPrimal for primal simplex variant
 * @see ClpDualRowPivot for pivot row selection strategies
 * @see ClpDualRowSteepest, ClpDualRowDantzig for specific strategies
 */
