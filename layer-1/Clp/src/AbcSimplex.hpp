 ...
 * that are better suited for vectorized operations.
 *
 * @see ClpSimplex for the standard (non-AVX) implementation
 * @see AbcSimplexDual for AVX-optimized dual simplex
 * @see AbcSimplexPrimal for AVX-optimized primal simplex
 * @see AbcMatrix for the optimized matrix class
 */
