 ...
 * - Support for incremental factorization updates
 *
 * @see CoinWarmStartBasis in CoinUtils for the base class
 * @see AbcSimplex which uses warm starts
 * @see ClpSimplex::getWarmStart() for standard warm start creation
 */
