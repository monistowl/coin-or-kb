 ...
 *
 * @ref Dantzig, "Linear Programming and Extensions", Princeton (1963)
 * @ref Forrest & Goldfarb, "Steepest-edge simplex algorithms for LP",
 ...
 *
 * @see ClpSimplex for the base simplex class
 * @see ClpSimplexDual for dual simplex variant (often faster)
 * @see ClpPrimalColumnPivot for pivot column selection strategies
 * @see ClpPrimalColumnSteepest, ClpPrimalColumnDantzig for specific strategies
 */
