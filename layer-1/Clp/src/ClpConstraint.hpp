 ...
 * Row number -1 indicates this is an objective function, not a constraint.
 *
 * @see ClpObjective for objective function handling (similar interface)
 * @see ClpModel for standard linear constraint handling
 */
