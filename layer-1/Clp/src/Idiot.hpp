 ...
 * - crossOver(): Transition to simplex for exact solution
 *
 * @see ClpSimplex::initialSolve() which may call Idiot automatically
 * @see ClpSimplexPrimal for the simplex algorithm that uses the crash solution
 */
