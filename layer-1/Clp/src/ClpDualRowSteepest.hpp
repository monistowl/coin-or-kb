...
/**
 * @file ClpDualRowSteepest.hpp
 * @brief Steepest edge pivot selection for dual simplex
 *
 * @algorithm Steepest Edge Dual Pivot Selection:
 ...
 *
 * @math Edge weight: γ_i = ||B^{-T}e_i||² = (i-th row of B^{-1})^T(i-th row of B^{-1})
 ...
 * @see ClpDualRowDantzig for simpler but often slower alternative
