 ...
 * - AbcTolerancesEtc class for algorithm tolerance parameters
 *
 * @see AbcSimplex for the main ABC simplex implementation
 * @see CoinAbcFactorization for the optimized factorization
 */
