...
/**
 * @file ClpFactorization.hpp
 * @brief Wrapper around CoinFactorization for use within Clp simplex
 *
 * @algorithm LU Factorization with Forrest-Tomlin Updates:
 ...
 *
 * @math Basis matrix B ∈ ℝ^{m×m} where columns are basic column vectors from [A|I].
 ...
 *
 * @ref Forrest & Tomlin, "Updated triangular factors of the basis to maintain
 *      sparsity in the product form simplex method", Mathematical Programming 2 (1972)
 * @ref Suhl & Suhl, "Computing sparse LU factorizations for large-scale LP bases",
 ...
 *
 * @see CoinFactorization in CoinUtils for the underlying LU implementation
 * @see ClpNetworkBasis for special network structure handling
 * @see ClpSimplex for how factorization integrates with simplex iterations
 */
