...
/**
 * @file ClpPlusMinusOneMatrix.hpp
 ...
 * few distinct coefficient values, using a pool of unique elements.
 *
 * @see ClpMatrixBase for the abstract matrix interface
 * @see ClpNetworkMatrix for pure network structure (+1/-1 with 2 per column)
 * @see ClpPackedMatrix for general sparse storage
 */
