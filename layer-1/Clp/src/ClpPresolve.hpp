 ...
 *
 * @ref Andersen & Andersen, "Presolving in LP", Mathematical Programming 71 (1995)
 * @ref Gondzio, "Presolve analysis of LP problems prior to IPM",
 ...
 *
 * @see CoinPresolveMatrix in CoinUtils for the transformation framework
 * @see ClpSimplex::initialSolve() which can invoke presolve automatically
 */
