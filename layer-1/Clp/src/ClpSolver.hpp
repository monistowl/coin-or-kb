 ...
 * - userChoiceWasGood(): Post-pivot callback
 *
 * @see ClpParameters for parameter handling
 * @see AbcSimplex for the ABC optimized variant
 * @see Clp_C_Interface.h for C language bindings
 */
