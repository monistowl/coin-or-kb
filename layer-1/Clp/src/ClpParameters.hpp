 ...
 * Organized into categories: strategy, display, algorithm control.
 *
 * @see ClpParam for individual parameter definitions
 * @see CoinParam for the underlying parameter framework
 */
