...
/**
 * @file ClpDynamicExampleMatrix.hpp
 * @brief Example column generation matrix demonstrating dynamic pricing
 *
 * Teaching implementation showing how to implement column generation by
