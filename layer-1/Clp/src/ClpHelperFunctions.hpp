 ...
 *
 * ClpTraceDebug: Debug assertion macro (active when NDEBUG not defined).
 *
 * @see CoinHelperFunctions for general utility functions
 * @see ClpPdco for the PDCO interior point method
 */
