...
/**
 * @file ClpInterior.hpp
 * @brief Interior point (barrier) method for LP
 * @author John Tomlin (PDCO), John Forrest (predictor-corrector)
 *
 * @algorithm Interior Point Method (Barrier Method):
 ...
 *
 * @math Barrier problem: min c^Tx - μ∑log(x_j-l_j) - μ∑log(u_j-x_j)
 ...
 *
 * @ref Mehrotra, "On the implementation of a primal-dual interior point method",
 *      SIAM Journal on Optimization 2 (1992) 575-601
 * @ref Andersen & Andersen, "The MOSEK interior point optimizer for LP",
 ...
 *
 * @see ClpPredictorCorrector for the predictor-corrector implementation
 * @see ClpPdco for PDCO variant
 * @see ClpCholeskyBase for Cholesky factorization interface
 * @see ClpSimplex for the alternative simplex method
 */
