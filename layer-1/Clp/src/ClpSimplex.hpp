 ...
 * @see ClpSimplexDual for dual simplex implementation
 * @see ClpSimplexPrimal for primal simplex implementation
 * @see ClpFactorization for basis factorization
 * @see ClpDualRowPivot, ClpPrimalColumnPivot for pivot selection strategies
 * @see CoinFactorization in CoinUtils for the underlying LU factorization
 */
