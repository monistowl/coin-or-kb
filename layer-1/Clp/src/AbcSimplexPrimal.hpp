 ...
 * - lexSolve(): Lexicographic resolution for degeneracy
 *
 * @see AbcSimplex for the base optimized simplex class
 * @see AbcSimplexDual for optimized dual simplex
 * @see ClpSimplexPrimal for the standard (non-AVX) implementation
 */
