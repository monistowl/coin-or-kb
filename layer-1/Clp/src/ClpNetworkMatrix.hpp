 ...
 * A row index of -1 indicates a slack arc with only one endpoint.
 *
 * @see ClpMatrixBase for the abstract matrix interface
 * @see ClpPackedMatrix for general sparse matrix storage
 * @see CoinPackedMatrix in CoinUtils for underlying sparse format
 */
