...
/**
 * @brief Abstract base class for branchable objects in MIP
 *
 * An object is anything with a feasible region that can be:
 * - Evaluated for infeasibility
 * - Branched on to move toward feasibility
 * - Compared for branching priority
 *
 * Common object types:
 * - Integer variables (most common)
 * - SOS Type 1 constraints (at most one nonzero)
 * - SOS Type 2 constraints (at most two adjacent nonzeros)
