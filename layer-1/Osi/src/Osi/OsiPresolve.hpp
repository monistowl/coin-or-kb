 ...
 * 3. postsolve() transforms solution back to original space
 *
 * @see CoinPresolveMatrix for implementation details
 * @see ClpPresolve for Clp-specific presolve
 */
