...
/**
 * @brief Column cut with tightened variable bounds
 *
 * Stores new lower and upper bounds for a subset of variables.
 * More efficient than row cuts when only bounds change.
 */
