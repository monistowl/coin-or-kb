 ...
 * @see OsiCuts for managing collections of cuts
 * @see Cgl (Cut Generation Library) for cut generators
 */
...
/**
 * @brief Abstract base class for cutting planes
 *
 * Provides common functionality for all cut types:
 * - Effectiveness measure for cut selection/ranking
 * - Global validity flag (can cut be used anywhere in B&B tree?)
 * - Consistency and infeasibility checks
 *
 * @invariant Effectiveness is typically the cut violation at LP optimum
 * @invariant Comparison operators use effectiveness for sorting
 */
