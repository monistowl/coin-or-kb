...
/**
 * @brief Variable selection for branching in MIP
 *
 * Chooses which infeasible integer variable to branch on.
 * Base class uses simple heuristics; derived classes can
 * implement strong branching or other strategies.
