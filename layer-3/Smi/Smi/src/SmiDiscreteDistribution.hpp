...
/**
 * @file SmiDiscreteDistribution.hpp
 ...
 * ```
 *
 * @see SmiScnModel.hpp::processDiscreteDistributionIntoScenarios()
 * @see SmiLinearData.hpp for LP data container
 * @see SmiCoreCombineRule.hpp for combination rules
 */
