 ...
 *
 * @see SmiScenarioTree.hpp for tree data structure
 * @see SmiScnData.hpp for core/node data classes
 * @see SmiSmpsIO.hpp for SMPS file I/O
 * @see SmiCoreCombineRule.hpp for replace/add rules
 */
