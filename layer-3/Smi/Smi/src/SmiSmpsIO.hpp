 ...
 *
 * @see SmiScnModel.hpp::readSmps() for high-level interface
 * @see SmiScnData.hpp for SmiCoreData created from core file
 * @see CoinMpsIO (CoinUtils) for MPS parsing base
 */
