 ...
 *
 * @see AlpsDecompTreeNode.h for B&B tree nodes
 * @see DecompAlgo.h for the algorithm being integrated
 * @see AlpsModel (ALPS) for base class interface
 */
