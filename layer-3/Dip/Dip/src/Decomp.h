 ...
 * - DecompZero: Near-zero threshold (1e-14)
 *
 * @see DecompAlgo.h for base algorithm class
 * @see DecompApp.h for user application interface
 * @see DecompParam.h for algorithm parameters
 */
