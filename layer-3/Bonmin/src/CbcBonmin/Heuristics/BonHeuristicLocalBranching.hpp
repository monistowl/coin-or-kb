 ...
 * For binary variables: sum_{x*_i=1}(1-x_i) + sum_{x*_i=0}(x_i) <= k
 *
 * @see LocalSolverBasedHeuristic for base class
 * @see TNLP2FPNLP for local branching constraint implementation
 */
...
namespace Bonmin {
  class BONMINLIB_EXPORT HeuristicLocalBranching : public LocalSolverBasedHeuristic {
    public:
     /** Default constructor*/
