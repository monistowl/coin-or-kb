 ...
 * relaxing or fixing integer variables.
 *
 * @see BonTMINLP2TNLP.hpp for TMINLP to TNLP conversion
 * @see BonOsiTMINLPInterface.hpp for OsiSolverInterface wrapper
 * @see IpTNLP.hpp for Ipopt's NLP interface (parent of continuous relaxation)
 */
