 ...
 * - 2: Interior point warm start (preserves barrier info)
 *
 * @see TNLPSolver for the abstract interface
 * @see IpoptWarmStart for warm start data storage
 * @see IpoptInteriorWarmStarter for advanced interior point warm start
 */
