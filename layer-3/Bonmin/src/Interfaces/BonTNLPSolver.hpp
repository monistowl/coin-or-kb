 ...
 *
 * @see BonIpoptSolver.hpp for Ipopt-specific implementation
 * @see BonFilterSolver.hpp for FilterSQP implementation
 * @see IpTNLP.hpp for the NLP problem interface
 */
#ifndef TNLPSolver_H
#define TNLPSolver_H
#include "IpTNLP.hpp"
