 ...
 *
 * @see AlpsSearchStrategy.h for concrete implementations
 * @see AlpsNodePool for node selection usage
 * @see AlpsSubTreePool for subtree selection usage
 */
