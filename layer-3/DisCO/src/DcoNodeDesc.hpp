 ...
 *
 * @see DcoTreeNode.hpp for the node using this descriptor
 * @see DcoBranchObject.hpp for branching decisions
 * @see CoinWarmStartBasis (CoinUtils) for LP basis
 */
