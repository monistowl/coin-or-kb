 ...
 * - lb_multiplier: Floor(lb*multiplier) to avoid rounding errors
 *
 * @see BCP_tm_user for user customization hooks
 * @see BCP_lp.hpp for LP process that receives work
 */
