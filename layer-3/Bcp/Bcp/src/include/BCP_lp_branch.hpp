 ...
 * 4. Best candidate selected based on results
 *
 * @see BCP_branch.hpp for internal branching representation
 * @see BCP_lp_user::select_branching_candidates()
 * @see OsiBranchingObject for OSI branching interface
 */
