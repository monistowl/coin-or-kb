 ...
 * For cheap cuts, generate locally in BCP_lp_user instead.
 *
 * @see BCP_cg.hpp for Cut Generator process internals
 * @see BCP_lp_user for LP-side cut generation
 * @see BCP_cg_param.hpp for CG parameters
 */
