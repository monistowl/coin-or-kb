 ...
 * it sends duals to VG. New columns restore feasibility.
 *
 * @see BCP_vg_user for user override points
 * @see BCP_lp.hpp for LP process that requests columns
 * @see BCP_var.hpp for variable representation
 */
