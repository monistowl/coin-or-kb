 ...
 * - warmstartRoot: Optional warm start from root for all nodes
 *
 * @see BCP_lp_user for user customization hooks
 * @see BCP_tm.hpp for Tree Manager that assigns work
 */
