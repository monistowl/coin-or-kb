 ...
 *
 * @see BlisHeurRound for simple rounding heuristic
 * @see BlisModel::addHeuristic() for registration
 * @see BlisModel::callHeuristics() for invocation
 */
