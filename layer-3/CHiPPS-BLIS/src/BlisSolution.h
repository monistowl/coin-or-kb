 ...
 *
 * @see BcpsSolution for base class with size_, values_, quality_
 * @see AlpsSolutionPool for solution storage
 * @see BlisHeuristic::searchSolution() which returns these
 */
...
class BLISLIB_EXPORT BlisSolution : public BcpsSolution {
