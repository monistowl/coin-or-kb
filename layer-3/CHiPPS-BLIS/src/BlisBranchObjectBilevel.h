...
/**
 * @file BlisBranchObjectBilevel.h
 ...
 *
 * @see BlisBranchStrategyBilevel for bilevel branching strategy
 * @see BlisBranchObjectInt for standard integer branching
 */
...
class BLISLIB_EXPORT BlisBranchObjectBilevel : public BcpsBranchObject {
