 ...
 *
 * @see BlisConstraint for the constraint representation
 * @see CglCutGenerator for the CGL base class
 * @see BlisModel::addCutGenerator() for registration
 */
