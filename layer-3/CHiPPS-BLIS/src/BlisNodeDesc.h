 ...
 *
 * @see BlisTreeNode for the node using this description
 * @see CoinWarmStartBasis for LP basis representation
 * @see BlisPseudocost::update() which uses branching history
 */
