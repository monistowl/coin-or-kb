 ...
 *
 * @see BlisBranchObjectInt for the branching action
 * @see BlisPseudocost for pseudo-cost data structure
 * @see BlisBranchStrategyPseudo for pseudo-cost branching
 */
