 ...
 *
 * @see BlisObjectInt for the integer variable object
 * @see BlisBranchStrategy* for variable selection
 * @see BlisTreeNode::branch() for branching implementation
 */
