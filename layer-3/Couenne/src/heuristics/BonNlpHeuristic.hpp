 ...
 * - NlpHeuristic: Only triggers when already near-feasible
 *
 * @see CouenneFeasPump for feasibility pump heuristic
 * @see InitHeuristic for initial solution injection
 */
