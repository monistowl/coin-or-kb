 ...
 *
 * @see exprClone for non-owning copy (different destructor behavior)
 * @see exprStore for stored value version
 * @see expression base class
 */
