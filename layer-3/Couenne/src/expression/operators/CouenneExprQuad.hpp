 ...
 * - quadCuts(): Generate OA cuts from alpha-convexification
 *
 * @see CouenneExprGroup for linear + nonlinear base class
 * @see CouenneExprMul for bilinear terms (McCormick)
 */
