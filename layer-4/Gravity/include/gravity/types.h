 ...
 * - C: Complex numbers
 *
 * @see gravity/var.h for variable declarations over indices
 * @see gravity/constraint.h for constraints over index sets
 * @see gravity/model.h for combining all components
 */
