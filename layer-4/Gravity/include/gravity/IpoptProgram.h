 ...
 *
 * @algorithm Interior Point Method via Ipopt
 * @see gravity/solver.h for unified solver interface
 * @see layer-2/Ipopt/ for Ipopt implementation details
 */
