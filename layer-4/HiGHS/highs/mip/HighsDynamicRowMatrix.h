...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
/**
 * @file mip/HighsDynamicRowMatrix.h
 ...
 *
 * @see mip/HighsDomain.h for domain propagation using sign iteration
 * @see mip/HighsCutPool.h for similar dynamic cut storage
 */
