 ...
 *
 * @see presolve/HPresolve.h for presolve bound tightening
 * @see mip/HighsDomain.h for MIP propagation
 * @see util/HighsCDouble.h for compensated double arithmetic
 */
