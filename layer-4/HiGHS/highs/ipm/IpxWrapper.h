 ...
 *
 * @see ipm/ipx/lp_solver.h for IPX solver class
 * @see ipm/IpxSolution.h for IPX solution struct
 * @see lp_data/HighsSolution.h for solution conversion utilities
 */
