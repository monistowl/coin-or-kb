 ...
 ***********************************************************************/
/**
 * @file Modules/Compiler/location_own.hh
 * @brief Custom Bison location adapter (alternate)
 *
 * Same as location.hh - replaces Bison-generated location type.
 *
 * @see location.hh
 * @see Control/LocationInfo.hh
 */
