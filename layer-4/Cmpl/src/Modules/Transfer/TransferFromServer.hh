...
{
    /**
	 * <code>TransferFromServer</code> wait for a result from the server and read then the result data back into the client cmpl.
	 */
	class TransferFromServer : public ModuleBase
	{
	...
	private:
		...
		int _serverJobId;						///< identification number of the server job, used to identify the matching data from server
	...
	private:
		 ...
		 */
		void readDataFromServerCmpl(istream &s, PositionInfo& pos);
	};
}

#endif // TRANSFERFROMSERVER_HH
