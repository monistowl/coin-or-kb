 ...
 ***********************************************************************/
/**
 * @file CommonData/IntCode.hh
 * @brief Intermediary code (bytecode) for CMPL virtual machine
 *
 * Stack-based bytecode generated by Compiler, executed by Interpreter.
 *
 * **IcElem Struct (Code Element):**
 * - IcCommand: Opcode with major/minor/par/cnt
 * - icTypeInt/icTypeReal: Literal operands
 * - icTypeNo2: Two symbol numbers
 *
 * **Major Opcodes:**
 * - INTCODE_LIT_VAL: Push literal value
 * - INTCODE_FETCH: Get symbol value
 * - INTCODE_ASSIGN: Store to lvalue
 * - INTCODE_OPERATION: Arithmetic/logic ops
