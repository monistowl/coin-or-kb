...
{
    /**
	 * <code>InputFunctionsMod</code> is the extension module class for extension <code>InputFunctions</code>
	 * which defines math functions for cmpl.
	 */
	class InputFunctionsMod : public ExtensionModule
	{
