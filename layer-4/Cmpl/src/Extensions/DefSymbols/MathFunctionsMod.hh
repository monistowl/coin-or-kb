...
{
    /**
	 * <code>MathFunctionsMod</code> is the extension module class for extension <code>MathFunctions</code>
	 * which defines math functions for cmpl.
	 */
	class MathFunctionsMod : public ExtensionModule
	{
