 ...
 *
 * @algorithm Operator Overloading for AD:
 ...
 *
 * @math Derivative propagation through operators:
 ...
 * - exp(a): ∂/∂a = exp(a)
 *
 * @complexity Each operation: O(1) time to record, O(1) space on tape.
 * Derivative propagation: O(1) per operation in forward/reverse sweep.
 *
 * @see adolc.h for main include
 * @see interfaces.h for derivative computation functions
 * @see adtl.h for tape-less forward mode alternative
 */
