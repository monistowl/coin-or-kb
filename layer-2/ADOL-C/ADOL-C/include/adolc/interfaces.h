 ...
 *
 * @algorithm Forward and Reverse Mode Tape Evaluation:
 *
 ...
 * - hov_reverse(tag, m, n, d, q, U, Z, nz): q adjoints for d-order Taylor
 *
 * @math Key complexity insight:
 ...
 * - ti: Taylor input (provide input Taylor coefficients)
 *
 * @complexity Forward: O(d·p·ops) for d-order, p directions.
 * Reverse: O(d·q·ops) for d-order, q adjoints.
 *
 * @see drivers/drivers.h for easy-to-use wrapper functions
 * @see tape_interface.h for tape management (trace_on, trace_off)
 */
