 ...
 * - Eigenvalue computations for inertia
 *
 * @see IpDenseGenMatrix.hpp for general (non-symmetric) variant
 * @see IpMultiVectorMatrix.hpp for high-rank update operands
 */
