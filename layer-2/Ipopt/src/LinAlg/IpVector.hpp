 ...
 * actual computation (e.g., CopyImpl, AxpyImpl, DotImpl).
 *
 * @see IpDenseVector.hpp for primary implementation
 * @see IpCompoundVector.hpp for composite vectors
 * @see IpMatrix.hpp for matrix abstraction
 */
