 ...
 * - Building composite matrix structures lazily
 *
 * @see IpSumSymMatrix.hpp for symmetric version
 * @see IpCompoundMatrix.hpp for block structure (vs linear combination)
 */
