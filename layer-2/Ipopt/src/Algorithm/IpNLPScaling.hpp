 ...
 *
 * @see IpGradientScaling.hpp for gradient-based implementation
 * @see IpEquilibrationScaling.hpp for equilibration
 * @see IpScaledMatrix.hpp for scaled matrix representation
 */
