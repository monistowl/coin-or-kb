 ...
 *   (requires solving augmented system)
 *
 * @see IpLeastSquareMults.hpp for the main implementation
 * @see IpDefaultIterateInitializer.hpp for usage in initialization
 * @see IpIpoptAlg.hpp for recalc_y usage
 */
