...
/**
 * @file IpBacktrackingLSAcceptor.hpp
 ...
 * - InitThisLineSearch(): Called at start of each line search
 *
 * @see IpBacktrackingLineSearch.hpp for the line search framework
 * @see IpFilterLSAcceptor.hpp for filter-based implementation
 * @see IpFilter.hpp for filter data structure
 */
