 ...
 * - Provides access to original filter/acceptor state
 *
 * @see IpOptErrorConvCheck.hpp for base convergence check
 * @see IpRestoFilterConvCheck.hpp for filter implementation
 */
