...
/**
 * @file IpMa77SolverInterface.hpp
 ...
 *
 * The solver creates 4 temporary files (fname1-4) for factor storage.
 *
 * @see IpMa86SolverInterface.hpp for in-core parallel solver
 * @see IpMa97SolverInterface.hpp for modern in-core solver
 */
