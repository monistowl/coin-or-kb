...
/**
 * @file IpMa97SolverInterface.hpp
 ...
 *
 * Recommended as default HSL solver for parallel systems.
 *
 * @see IpMa86SolverInterface.hpp for older parallel solver
 * @see IpMa57TSolverInterface.hpp for serial solver
 */
