 ...
 * if initial workspace estimates prove insufficient.
 *
 * @see IpMa57TSolverInterface.hpp for improved MA57
 * @see IpSparseSymLinearSolverInterface.hpp for interface
 */
