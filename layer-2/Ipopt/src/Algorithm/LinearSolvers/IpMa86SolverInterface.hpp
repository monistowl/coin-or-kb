...
/**
 * @file IpMa86SolverInterface.hpp
 ...
 * across factorizations with the same sparsity pattern.
 *
 * @see IpMa77SolverInterface.hpp for out-of-core solver
 * @see IpMa97SolverInterface.hpp for newer parallel solver
 */
