...
/**
 * @file IpPardisoMKLSolverInterface.hpp
 ...
 * pardiso-project.org version.
 *
 * @see IpPardisoSolverInterface.hpp for pardiso-project.org version
 * @see IpMa97SolverInterface.hpp for HSL alternative
 */
