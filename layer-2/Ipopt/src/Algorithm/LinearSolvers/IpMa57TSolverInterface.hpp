...
/**
 * @file IpMa57TSolverInterface.hpp
 ...
 * - ma57_pre_alloc_: Factor for initial workspace allocation
 *
 * @see IpMa27TSolverInterface.hpp for simpler MA27
 * @see IpMa97SolverInterface.hpp for modern parallel solver
 */
