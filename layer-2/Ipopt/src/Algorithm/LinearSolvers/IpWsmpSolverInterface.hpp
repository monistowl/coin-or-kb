...
/**
 * @file IpWsmpSolverInterface.hpp
 ...
 *
 * Can optionally use PARDISO preprocessing for matching.
 *
 * @see IpIterativeWsmpSolverInterface.hpp for iterative mode
 * @see IpPardisoSolverInterface.hpp for similar direct solver
 */
