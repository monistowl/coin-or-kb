...
/**
 * @file IpPardisoSolverInterface.hpp
 ...
 *
 * MTYPE=-2 indicates real symmetric indefinite matrix.
 *
 * @see IpPardisoMKLSolverInterface.hpp for Intel MKL version
 * @see IpMa97SolverInterface.hpp for alternative parallel solver
 */
