 ...
 *
 * The matrix structure must remain fixed between Initialize and solve calls.
 *
 * @see IpSparseSymLinearSolverInterface.hpp for sparse format interface
 * @see IpTSymLinearSolver.hpp for triplet format driver
 */
