 ...
 * factorizations when the matrix hasn't changed.
 *
 * @see IpSparseSymLinearSolverInterface.hpp for solver interface
 * @see IpTripletToCSRConverter.hpp for format conversion
 * @see IpTSymScalingMethod.hpp for scaling
 */
