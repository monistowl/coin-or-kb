 ...
 * IpoptData stores curr_, trial_, delta_ as IteratesVectors.
 *
 * @see IpCompoundVector.hpp for the base class
 * @see IpIpoptData.hpp for storage of current/trial/delta iterates
 */
