 ...
 *
 * Pivoting strategies delegate to CoinBronKerbosch::PivotingStrategy.
 *
 * @see CoinBronKerbosch for the BK algorithm implementation
 * @see CoinConflictGraph for the graph data structure
 * @see CglClique for alternative clique separator
 * @see CglCliqueStrengthening for preprocessing with cliques
 *
