...
/**
 * @file CglMixedIntegerRounding2.hpp
 * @brief Enhanced MIR (Mixed Integer Rounding) cut generator
 * @author Joao Goncalves (Lehigh), Laszlo Ladanyi (IBM)
 *
 ...
 * - CRITERION_: Bound substitution strategy (1, 2, or 3)
 *
 * @see CglMixedIntegerRounding for original implementation
 * @see CglTwomir for two-step MIR
 */
