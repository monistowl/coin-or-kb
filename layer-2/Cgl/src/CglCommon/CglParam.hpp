 ...
 * @author Francois Margot (Carnegie Mellon)
 *
 ...
 * can validate parameter combinations or apply constraints.
 *
 * @see CglGMIParam, CglRedSplitParam for extended parameter classes
 */
