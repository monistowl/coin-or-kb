/**
 * @file CglRedSplitParam.hpp
 * @brief Parameters for the Reduce-and-Split cut generator
 * @author Francois Margot (Tepper School of Business, Carnegie Mellon)
 *
 ...
 * - normIsZero, minReduc: Reduction termination criteria
 *
 * @see CglRedSplit for the generator using these parameters
 * @see CglRedSplit2Param for enhanced version parameters
 * @see CglParam for base parameter class
 *
 * Date:     11/24/06
 *
 *-----------------------------------------------------------------------------
