/**
 * @file CglGMIParam.hpp
 * @brief Parameters for the GMI (Gomory Mixed-Integer) cut generator
 * @author Giacomo Nannicini (based on CglRedSplitParam by Francois Margot)
 *
 ...
 * Duplicate checking: CHECK_DUPLICATES (can be slow)
 *
 * @see CglGMI for the generator using these parameters
 * @see CglGomory for the classic Gomory generator
