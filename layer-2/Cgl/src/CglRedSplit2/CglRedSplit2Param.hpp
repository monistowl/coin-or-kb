/**
 * @file CglRedSplit2Param.hpp
 * @brief Parameters for the enhanced Reduce-and-Split cut generator
 * @author Giacomo Nannicini (Singapore University of Technology and Design)
 *
 ...
 * rank-1 split cuts in MIP", Math. Prog. Computation.
 *
 * @see CglRedSplit2 for the generator using these parameters
 * @see CglRedSplitParam for simpler parameter version
 * @see CglLandP for Lift & Project integration
 *
 * Date:     03/09/09
 *-----------------------------------------------------------------------------
...
class CGLLIB_EXPORT CglRedSplit2Param : public CglParam {
