...
/**
 * @file CglRedSplit2.hpp
 * @brief Enhanced Reduce-and-Split cuts with multiple strategies
 * @author Giacomo Nannicini (SUTD), based on CglRedSplit by F. Margot
 *
 * Based on papers:
 ...
 *
 * Does NOT generate same cuts as CglRedSplit - use both for best results.
 *
 * @see CglRedSplit2Param for extensive parameter control
 * @see CglRedSplit for original implementation
 * @see CglLandP for combined L&P + R&S cuts
 */
