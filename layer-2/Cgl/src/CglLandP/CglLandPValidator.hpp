 ...
 * Tracks rejection statistics by reason.
 *
 * @see CglLandPSimplex which uses this validator
 * @see CglLandP for the main cut generator
 * @see CglGMIParam for similar validation parameters
 *
 * Date:     11/22/05
 *
