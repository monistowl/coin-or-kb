 ...
 * @author Pierre Bonami (Carnegie Mellon/IBM)
 *
 ...
 *
 * Requires optimal basis.
 *
 * @see LAP::CglLandPSimplex for pivoting implementation
 * @see LAP::Validator for cut validation
 * @see CglLiftAndProject for simpler implementation
 */
