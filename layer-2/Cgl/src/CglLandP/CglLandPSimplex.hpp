 ...
 * @author Pierre Bonami (Tepper School of Business, Carnegie Mellon)
 *
 ...
 * Supports OsiClp for efficient basis operations when available.
 *
 * @algorithm Lift-and-Project Cutting Planes:
 ...
 *
 * @math For source row i with f_i fractional:
 ...
 *
 * @ref Balas, E. (1979). "Disjunctive Programming". Annals of Discrete
 *   Mathematics 5:3-51. [Theoretical foundation]
 *
 * @ref Balas, E. and Perregaard, M. (2003). "A precise correspondence between
 ...
 *
 * @see CglLandP for the main cut generator interface
 * @see CglLandPTabRow for tableau row structure
 * @see CglLandPValidator for cut acceptance criteria
 *
 * Date:     21/07/05
 *
