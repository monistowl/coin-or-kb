 ...
 * - numberPasses_/numberBadPasses_: Iteration limits
 *
 * @see CbcHeuristic for base class
 * @see CbcHeuristicRINS for simpler neighborhood search
 */
...
/** Dantzig-Wolfe decomposition heuristic (compute-intensive).
    Detects and exploits block-angular structure.
 */
