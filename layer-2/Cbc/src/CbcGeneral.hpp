 ...
 *
 * Pure virtual class - see CbcGeneralDepth for main implementation.
 *
 * @see CbcGeneralDepth for depth-limited partial evaluation
 * @see CbcNWay for simpler N-way branching
 *
