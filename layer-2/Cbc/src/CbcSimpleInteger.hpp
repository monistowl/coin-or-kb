 ...
 *
 * Also supports one-way branching for fixing variables.
 *
 * @see CbcObject for base class
 * @see CbcSimpleIntegerPseudoCost for pseudocost variant
 * @see CbcSimpleIntegerDynamicPseudoCost for dynamic pseudocosts
 * @see CbcBranchingObject for branching action base
 *
