 ...
 * N-way branch creates 5 children, each opening a different site.
 *
 * @see CbcNWayBranchingObject for branching action
 * @see CbcConsequence for side effects
 * @see CbcClique for clique-based (2-way) branching
 *
