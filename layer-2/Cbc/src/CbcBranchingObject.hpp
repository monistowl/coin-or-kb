 ...
 *
 * Extends OsiBranchingObject with CBC-specific features.
 *
 * @see CbcObject for what creates branching objects
 * @see CbcBranchDecision for choosing between objects
 * @see CbcIntegerBranchingObject for integer variable branching
 *
