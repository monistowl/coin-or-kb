 ...
 *
 * Uses lock counting for feasibility analysis.
 *
 * @see CbcHeuristicDiveFractional, CbcHeuristicDivePseudoCost, etc.
 * @see CbcHeuristic for base class
 * @see CbcHeuristicFPump for related approach
 */
