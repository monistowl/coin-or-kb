 ...
 *
 * Supports orbital branching for symmetry handling.
 *
 * @see CbcGeneral for base class
 * @see CbcSubProblem for subproblem representation
 * @see ClpNode, ClpNodeStuff for Clp integration
 *
