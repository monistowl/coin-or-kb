 ...
 * OsiSolverLinearizedQuadratic: Solver with linearized quadratic objective.
 *
 * @see CbcOsiSolver for base solver-model link
 * @see OsiBranchingObject for branching interface
 */
/* Contains: OsiSolverLink, OsiBranchLink, CglTemporary */
