 ...
 * @see CbcHeuristicDive for diving heuristics
 * @see CbcHeuristicRINS, CbcHeuristicRENS for neighborhood search
 * @see CbcHeuristicLocal for local search
 */
