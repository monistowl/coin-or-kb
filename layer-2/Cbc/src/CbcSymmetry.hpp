 ...
 * On one branch, fix variable to 1 and symmetric variables to 0.
 *
 * @see CbcBranchingObject for branching base class
 * @see nauty documentation for algorithm details
 */
/*
  Build instructions for nauty:
