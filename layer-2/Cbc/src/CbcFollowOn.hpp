 ...
 * before standard variable branching.
 *
 * @see CbcFixingBranchingObject for bulk variable fixing
 * @see CbcBranchCut for related cut-based branching
 *
