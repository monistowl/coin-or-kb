 ...
 *
 * @algorithm Branch-and-Bound Node Management:
 ...
 *
 * @ref Land & Doig, "An automatic method for solving discrete programming problems",
 ...
 *
 * @see CbcNodeInfo for persistent subproblem information
 * @see CbcTree for node storage and selection
 * @see CbcBranchingObject for branching decisions
 */
