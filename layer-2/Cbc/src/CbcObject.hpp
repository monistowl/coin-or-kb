 ...
 *
 * Note: Current implementation assumes binary branching (2 arms).
 *
 * @see CbcSimpleInteger for integer variable objects
 * @see CbcSOS for SOS Type 1/2 constraints
 * @see CbcBranchingObject for branching actions
 * @see OsiObject for OSI-level base class
 *
