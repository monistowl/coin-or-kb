 ...
 * applyToModel() walks ancestor chain to rebuild complete state.
 *
 * @see CbcNodeInfo for base class
 * @see CbcFullNodeInfo for complete state storage
 * @see CoinWarmStartDiff for basis difference representation
 *
