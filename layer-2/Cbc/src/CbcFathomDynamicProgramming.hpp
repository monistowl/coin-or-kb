/**
 * @file CbcFathomDynamicProgramming.hpp
 ...
 * Finds optimal solution by enumeration over all feasible states.
 *
 * @see CbcFathom for base class
 * @see CbcModel::fathom for integration point
 */
