/**
 * @file CbcSimpleIntegerDynamicPseudoCost.hpp
 ...
 * CbcSwitchingBinary for coupled binary/continuous variables.
 *
 * @see CbcSimpleIntegerPseudoCost for static pseudocost version
 * @see CbcBranchDynamicDecision for decision making with dynamic costs
 *
