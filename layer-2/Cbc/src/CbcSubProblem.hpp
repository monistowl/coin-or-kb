 ...
 * apply() restores state to solver (bounds, basis, or both).
 *
 * @see CbcHeuristicDive for diving heuristics using this
 * @see CbcNodeInfo for full search tree node storage
 * @see ClpNode for Clp-specific node representation
 *
