 ...
 * For direct API usage, prefer CbcModel directly.
 *
 * @see CbcModel for the core B&C solver
 * @see CbcParameters for parameter definitions
 * @see Cbc_C_Interface.h for C language bindings
 */
